package com.upgrade.paymentservice.controlleradvicer;

import com.upgrade.paymentservice.exception.ApiError;
...
public class TransactionControllerAdvicer extends ResponseEntityExceptionHandler {
    ...
    /**
     * Handle TransactionIdNotFoundException. Triggered when an object is Found Not.
     *
     * @param ex      the TransactionIdNotFoundException that is thrown when Id not found
     * @return the ApiError object
     */
